...
export type GetBooksReviewsQuery = { __typename?: 'Query', bookReviews: { __typename?: 'ReviewPagination', reviews: Array<{ __typename?: 'Review', UUID: string, description: string, rating: number, at: any, user?: { __typename?: 'UnstrictUser', name: string, UUID?: string | null } | null }>, pagination: { __typename?: 'PaginationInfo', totalPages: number, currentPage: number, isLastPage: boolean }, summary: { __typename?: 'ReviewSummary', total: number } } };
