...
export type UpdateUserLibraryMutation = { __typename?: 'Mutation', updateUserLibrary: { __typename?: 'updateUserResponse', success: boolean, message: string, user?: { __typename?: 'User', UUID: string } | null } };
